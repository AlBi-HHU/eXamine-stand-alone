...
internal class NetworkElementLayer<E, R : Node>(
        representationStyleClass: String,
        representationFactory: (E) -> R) : Pane() {

    private val representationStyleClass: String = requireNonNull(representationStyleClass)
    private val representationFactory: (E) -> R = requireNonNull(representationFactory)
    ...
    companion object {
        ...
        private val ELEMENT_HIGHLIGHTED_STYLE = "highlighted"
    }
}
